...
const COLLECTION_ART: Record<string, CollectionArt> = {
    "category:Birthday": { src: "/collections/birthday.webp", ink: "#F7F2E9", theme: "#120b0b", light: { src: "/collections/light/birthday.webp", ink: "#4a3c30", theme: "#dbd4c9" } },
    "category:Children's song": { src: "/collections/children.webp", ink: "#F4E2B9", theme: "#0f0c0a", light: { src: "/collections/light/children.webp", ink: "#7c2418", theme: "#67847b" } },
    "category:Christmas": { src: "/collections/christmas.webp", ink: "#F2E9D4", theme: "#181f1d", light: { src: "/collections/light/christmas.webp", ink: "#1e4a36", theme: "#c7cdd0" } },
    "category:Disney": { src: "/collections/disney.webp", ink: "#F5E5C0", theme: "#070b15", light: { src: "/collections/light/disney.webp", ink: "#5c4216", theme: "#a19174" } },
    "category:Eurovision": { src: "/collections/eurovision.webp", ink: "#E4E8F8", theme: "#060938", light: { src: "/collections/light/eurovision.webp", ink: "#3a424c", theme: "#9a8f80" } },
    "category:Hymn": { src: "/collections/hymn.webp", ink: "#F7F2E9", theme: "#161315", light: { src: "/collections/light/hymn.webp", ink: "#6e4214", theme: "#d0ad85" } },
    "category:Irish traditional": { src: "/collections/irish-traditional.webp", ink: "#E8D5C4", theme: "#091008", light: { src: "/collections/light/irish-traditional.webp", ink: "#3a4a18", theme: "#afb5b6" } },
    "category:James Bond": { src: "/collections/james-bond.webp", ink: "#F2EFE9", theme: "#161413", light: { src: "/collections/light/james-bond.webp", ink: "#1a5360", theme: "#a0bdc7" } },
    "category:Melodifestivalen": { src: "/collections/melodifestivalen.webp", ink: "#F6D4C8", theme: "#190c0d", light: { src: "/collections/light/melodifestivalen.webp", ink: "#18586a", theme: "#b6b1ad" } },
    "category:Midsummer": { src: "/collections/midsummer.webp", ink: "#F9EFE5", theme: "#252628", light: { src: "/collections/light/midsummer.webp", ink: "#3f4e16", theme: "#6796b6" } },
    "category:Musical": { src: "/collections/musical.webp", ink: "#F9E8D2", theme: "#080504", light: { src: "/collections/light/musical.webp", ink: "#6e1420", theme: "#2d090b" } },
    "decade:1950": { src: "/collections/50s.webp", ink: "#FDEBD0", theme: "#251308", light: { src: "/collections/light/50s.webp", ink: "#9a3e14", theme: "#eceae1" } },
    "decade:1960": { src: "/collections/60s.webp", ink: "#F7D8D0", theme: "#260c0b", light: { src: "/collections/light/60s.webp", ink: "#9a3a12", theme: "#af8967" } },
    "decade:1970": { src: "/collections/70s.webp", ink: "#F9F5E6", theme: "#1e1a12", light: { src: "/collections/light/70s.webp", ink: "#6e3814", theme: "#a57d43" } },
    "decade:1980": { src: "/collections/80s.webp", ink: "#FCE4EC", theme: "#130717", light: { src: "/collections/light/80s.webp", ink: "#3c3834", theme: "#cbc3b1" } },
    "decade:1990": { src: "/collections/90s.webp", ink: "#F2EBE1", theme: "#1c130d", light: { src: "/collections/light/90s.webp", ink: "#1c3a56", theme: "#cec6b4" } },
    "decade:2000": { src: "/collections/00s.webp", ink: "#E2E8F0", theme: "#0f1d2a", light: { src: "/collections/light/00s.webp", ink: "#2c3644", theme: "#eff2f6" } },
    "decade:2010": { src: "/collections/10s.webp", ink: "#F0F2F5", theme: "#0d141b", light: { src: "/collections/light/10s.webp", ink: "#16485a", theme: "#e3e8eb" } },
    "decade:2020": { src: "/collections/20s.webp", ink: "#EDE8FF", theme: "#161223", light: { src: "/collections/light/20s.webp", ink: "#4a4238", theme: "#d7d5d1" } },
    "genre:alternative rock": { src: "/collections/alternative-rock.webp", ink: "#E5DBD0", theme: "#020409", light: { src: "/collections/light/alternative-rock.webp", ink: "#5a4a32", theme: "#7f6f56" } },
    "genre:art rock": { src: "/collections/art-rock.webp", ink: "#DADDDA", theme: "#04070f", light: { src: "/collections/light/art-rock.webp", ink: "#3d2a48", theme: "#c3b7a9" } },
    "genre:blues": { src: "/collections/blues.webp", ink: "#ECD9C7", theme: "#020201", light: { src: "/collections/light/blues.webp", ink: "#7a4a14", theme: "#a0937d" } },
    "genre:blues rock": { src: "/collections/blues-rock.webp", ink: "#EDD9C5", theme: "#0f0e0d", light: { src: "/collections/light/blues-rock.webp", ink: "#5c3a18", theme: "#85745f" } },
    "genre:britpop": { src: "/collections/britpop.webp", ink: "#E6DBC7", theme: "#050402", light: { src: "/collections/light/britpop.webp", ink: "#6a3214", theme: "#abbabd" } },
    "genre:contemporary r&b": { src: "/collections/contemporary-r-and-b.webp", ink: "#E5DBCE", theme: "#080806", light: { src: "/collections/light/contemporary-r-and-b.webp", ink: "#7a5418", theme: "#c0d9e8" } },
    "genre:country": { src: "/collections/country.webp", ink: "#E0DCD4", theme: "#070a0f", light: { src: "/collections/light/country.webp", ink: "#5c4a28", theme: "#d1ddea" } },
    ...
    "genre:country rock": { src: "/collections/country-rock.webp", ink: "#EDD9C4", theme: "#030201", light: { src: "/collections/light/country-rock.webp", ink: "#3a4a20", theme: "#bdb8b0" } },
    "genre:dance": { src: "/collections/dance.webp", ink: "#DFDCD5", theme: "#020305", light: { src: "/collections/light/dance.webp", ink: "#4a4c18", theme: "#989272" } },
    "genre:dance-pop": { src: "/collections/dance-pop.webp", ink: "#D8DBEE", theme: "#010102", light: { src: "/collections/light/dance-pop.webp", ink: "#8a3a28", theme: "#d5bea0" } },
    "genre:disco": { src: "/collections/disco.webp", ink: "#E9DAC8", theme: "#030303", light: { src: "/collections/light/disco.webp", ink: "#7a5416", theme: "#d1be9e" } },
    "genre:electronic": { src: "/collections/electronic.webp", ink: "#E3DBD1", theme: "#08080a", light: { src: "/collections/light/electronic.webp", ink: "#2c3a55", theme: "#d2cbbf" } },
    "genre:electropop": { src: "/collections/electropop.webp", ink: "#CCDEF2", theme: "#010102", light: { src: "/collections/light/electropop.webp", ink: "#6a2a4c", theme: "#cccbca" } },
    "genre:europop": { src: "/collections/europop.webp", ink: "#D8DDDE", theme: "#20262c", light: { src: "/collections/light/europop.webp", ink: "#6e5418", theme: "#efefef" } },
    "genre:folk": { src: "/collections/folk.webp", ink: "#F8D7BB", theme: "#030302", light: { src: "/collections/light/folk.webp", ink: "#3e4a1c", theme: "#dee4e6" } },
    "genre:folk rock": { src: "/collections/folk-rock.webp", ink: "#EBDAC8", theme: "#0c0908", light: { src: "/collections/light/folk-rock.webp", ink: "#8a4c12", theme: "#b9a486" } },
    "genre:funk": { src: "/collections/funk.webp", ink: "#FFD5B2", theme: "#060301", light: { src: "/collections/light/funk.webp", ink: "#7a4c12", theme: "#ac9277" } },
    "genre:glam metal": { src: "/collections/glam-metal.webp", ink: "#F1D6D8", theme: "#050002", light: { src: "/collections/light/glam-metal.webp", ink: "#2c2826", theme: "#b6b1ae" } },
    "genre:glam rock": { src: "/collections/glam-rock.webp", ink: "#DDDBE1", theme: "#020103", light: { src: "/collections/light/glam-rock.webp", ink: "#7a1818", theme: "#d8c7b3" } },
    "genre:hard rock": { src: "/collections/hard-rock.webp", ink: "#FAD6C3", theme: "#0a090a", light: { src: "/collections/light/hard-rock.webp", ink: "#8a3c10", theme: "#9a948e" } },
    ...
    "genre:hip hop": { src: "/collections/hip-hop.webp", ink: "#F4D8B8", theme: "#010103", light: { src: "/collections/light/hip-hop.webp", ink: "#7a3a22", theme: "#f3e3c8" } },
    "genre:indie rock": { src: "/collections/indie-rock.webp", ink: "#E6DBCC", theme: "#010306", light: { src: "/collections/light/indie-rock.webp", ink: "#5c4a34", theme: "#7d7162" } },
    "genre:jazz": { src: "/collections/jazz.webp", ink: "#E6DBCC", theme: "#141415", light: { src: "/collections/light/jazz.webp", ink: "#6e4c16", theme: "#cec5b9" } },
    "genre:new wave": { src: "/collections/new-wave.webp", ink: "#F0D7D4", theme: "#040306", light: { src: "/collections/light/new-wave.webp", ink: "#8a1c1c", theme: "#dbd7d4" } },
    "genre:pop": { src: "/collections/pop.webp", ink: "#F4ECD8", theme: "#0d0e0e", light: { src: "/collections/light/pop.webp", ink: "#3a3532", theme: "#cebda6" } },
    "genre:pop punk": { src: "/collections/pop-punk.webp", ink: "#DFDCD6", theme: "#000000", light: { src: "/collections/light/pop-punk.webp", ink: "#3a3228", theme: "#8c7e6d" } },
    "genre:pop rap": { src: "/collections/pop-rap.webp", ink: "#FCD2E1", theme: "#0f0b11", light: { src: "/collections/light/pop-rap.webp", ink: "#5c3a1c", theme: "#e4dfdc" } },
    "genre:pop rock": { src: "/collections/pop-rock.webp", ink: "#EFD9BF", theme: "#0a1110", light: { src: "/collections/light/pop-rock.webp", ink: "#4a4a28", theme: "#ecf4fc" } },
    "genre:post-grunge": { src: "/collections/post-grunge.webp", ink: "#DEDCD5", theme: "#060806", light: { src: "/collections/light/post-grunge.webp", ink: "#4a3a28", theme: "#e4e7eb" } },
    ...
    "genre:rock": { src: "/collections/rock.webp", ink: "#EADCBF", theme: "#080506", light: { src: "/collections/light/rock.webp", ink: "#6e3210", theme: "#c1ab98" } },
    "genre:rock and roll": { src: "/collections/rock-and-roll.webp", ink: "#F2D9BC", theme: "#010000", light: { src: "/collections/light/rock-and-roll.webp", ink: "#8a2018", theme: "#aba6a1" } },
    "genre:rockabilly": { src: "/collections/rockabilly.webp", ink: "#EDD9C7", theme: "#010101", light: { src: "/collections/light/rockabilly.webp", ink: "#8a1810", theme: "#ad8373" } },
    ...
    "genre:soft rock": { src: "/collections/soft-rock.webp", ink: "#ECD9C8", theme: "#000000", light: { src: "/collections/light/soft-rock.webp", ink: "#6a3a14", theme: "#c2dfef" } },
    "genre:soul": { src: "/collections/soul.webp", ink: "#EED9C4", theme: "#0f0b05", light: { src: "/collections/light/soul.webp", ink: "#7a4c14", theme: "#8e7a5c" } },
    "genre:synth-pop": { src: "/collections/synth-pop.webp", ink: "#D2DEE8", theme: "#000103", light: { src: "/collections/light/synth-pop.webp", ink: "#5a3e28", theme: "#c3c0b3" } },
    "genre:teen pop": { src: "/collections/teen-pop.webp", ink: "#F7D4D9", theme: "#040204", light: { src: "/collections/light/teen-pop.webp", ink: "#7a3a40", theme: "#c5b6a4" } },
