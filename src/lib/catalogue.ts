...
const COLLECTION_ART: Record<string, CollectionArt> = {
    "category:Birthday": { src: "/collections/birthday.webp", ink: "#F7F2E9", theme: "#120b0b", light: { src: "/collections/light/birthday.webp", ink: "#2f2b26", theme: "#dbd4c9" } },
    "category:Children's song": { src: "/collections/children.webp", ink: "#F4E2B9", theme: "#0f0c0a", light: { src: "/collections/light/children.webp", ink: "#29251e", theme: "#67847b" } },
    "category:Christmas": { src: "/collections/christmas.webp", ink: "#F2E9D4", theme: "#181f1d", light: { src: "/collections/light/christmas.webp", ink: "#2b2925", theme: "#c7cdd0" } },
    "category:Disney": { src: "/collections/disney.webp", ink: "#F5E5C0", theme: "#070b15", light: { src: "/collections/light/disney.webp", ink: "#29241e", theme: "#a19174" } },
    "category:Eurovision": { src: "/collections/eurovision.webp", ink: "#E4E8F8", theme: "#060938", light: { src: "/collections/light/eurovision.webp", ink: "#36332e", theme: "#9a8f80" } },
    "category:Hymn": { src: "/collections/hymn.webp", ink: "#F7F2E9", theme: "#161315", light: { src: "/collections/light/hymn.webp", ink: "#2c261e", theme: "#d0ad85" } },
    "category:Irish traditional": { src: "/collections/irish-traditional.webp", ink: "#E8D5C4", theme: "#091008", light: { src: "/collections/light/irish-traditional.webp", ink: "#363522", theme: "#afb5b6" } },
    "category:James Bond": { src: "/collections/james-bond.webp", ink: "#F2EFE9", theme: "#161413", light: { src: "/collections/light/james-bond.webp", ink: "#2c2a25", theme: "#a0bdc7" } },
    "category:Melodifestivalen": { src: "/collections/melodifestivalen.webp", ink: "#F6D4C8", theme: "#190c0d", light: { src: "/collections/light/melodifestivalen.webp", ink: "#3b3631", theme: "#b6b1ad" } },
    "category:Midsummer": { src: "/collections/midsummer.webp", ink: "#F9EFE5", theme: "#252628", light: { src: "/collections/light/midsummer.webp", ink: "#2a2926", theme: "#6796b6" } },
    "category:Musical": { src: "/collections/musical.webp", ink: "#F9E8D2", theme: "#080504", light: { src: "/collections/light/musical.webp", ink: "#d1c6bf", theme: "#2d090b" } },
    "decade:1950": { src: "/collections/50s.webp", ink: "#FDEBD0", theme: "#251308", light: { src: "/collections/light/50s.webp", ink: "#2e2922", theme: "#eceae1" } },
    "decade:1960": { src: "/collections/60s.webp", ink: "#F7D8D0", theme: "#260c0b", light: { src: "/collections/light/60s.webp", ink: "#dbd1c5", theme: "#af8967" } },
    "decade:1970": { src: "/collections/70s.webp", ink: "#F9F5E6", theme: "#1e1a12", light: { src: "/collections/light/70s.webp", ink: "#3d3123", theme: "#a57d43" } },
    "decade:1980": { src: "/collections/80s.webp", ink: "#FCE4EC", theme: "#130717", light: { src: "/collections/light/80s.webp", ink: "#2d2924", theme: "#cbc3b1" } },
    "decade:1990": { src: "/collections/90s.webp", ink: "#F2EBE1", theme: "#1c130d", light: { src: "/collections/light/90s.webp", ink: "#28241f", theme: "#cec6b4" } },
    "decade:2000": { src: "/collections/00s.webp", ink: "#E2E8F0", theme: "#0f1d2a", light: { src: "/collections/light/00s.webp", ink: "#2b2824", theme: "#eff2f6" } },
    "decade:2010": { src: "/collections/10s.webp", ink: "#F0F2F5", theme: "#0d141b", light: { src: "/collections/light/10s.webp", ink: "#2e2c28", theme: "#e3e8eb" } },
    "decade:2020": { src: "/collections/20s.webp", ink: "#EDE8FF", theme: "#161223", light: { src: "/collections/light/20s.webp", ink: "#2e2b27", theme: "#d7d5d1" } },
    "genre:alternative rock": { src: "/collections/alternative-rock.webp", ink: "#E5DBD0", theme: "#020409", light: { src: "/collections/light/alternative-rock.webp", ink: "#29251f", theme: "#7f6f56" } },
    "genre:art rock": { src: "/collections/art-rock.webp", ink: "#DADDDA", theme: "#04070f", light: { src: "/collections/light/art-rock.webp", ink: "#2d2925", theme: "#c3b7a9" } },
    "genre:blues": { src: "/collections/blues.webp", ink: "#ECD9C7", theme: "#020201", light: { src: "/collections/light/blues.webp", ink: "#28241e", theme: "#a0937d" } },
    "genre:blues rock": { src: "/collections/blues-rock.webp", ink: "#EDD9C5", theme: "#0f0e0d", light: { src: "/collections/light/blues-rock.webp", ink: "#dad1c5", theme: "#85745f" } },
    "genre:britpop": { src: "/collections/britpop.webp", ink: "#E6DBC7", theme: "#050402", light: { src: "/collections/light/britpop.webp", ink: "#d6cfc6", theme: "#abbabd" } },
    "genre:contemporary r&b": { src: "/collections/contemporary-r-and-b.webp", ink: "#E5DBCE", theme: "#080806", light: { src: "/collections/light/contemporary-r-and-b.webp", ink: "#2e2c29", theme: "#c0d9e8" } },
    "genre:country": { src: "/collections/country.webp", ink: "#E0DCD4", theme: "#070a0f", light: { src: "/collections/light/country.webp", ink: "#2a2620", theme: "#d1ddea" } },
    "genre:country pop": { src: "/collections/country-pop.webp", ink: "#E8DACB", theme: "#050403", light: { src: "/collections/light/country-pop.webp", ink: "#2a2722", theme: "#e6dfd1" } },
    "genre:country rock": { src: "/collections/country-rock.webp", ink: "#EDD9C4", theme: "#030201", light: { src: "/collections/light/country-rock.webp", ink: "#d7d0c1", theme: "#bdb8b0" } },
    "genre:dance": { src: "/collections/dance.webp", ink: "#DFDCD5", theme: "#020305", light: { src: "/collections/light/dance.webp", ink: "#2d2a26", theme: "#989272" } },
    "genre:dance-pop": { src: "/collections/dance-pop.webp", ink: "#D8DBEE", theme: "#010102", light: { src: "/collections/light/dance-pop.webp", ink: "#2e2923", theme: "#d5bea0" } },
    "genre:disco": { src: "/collections/disco.webp", ink: "#E9DAC8", theme: "#030303", light: { src: "/collections/light/disco.webp", ink: "#2e2922", theme: "#d1be9e" } },
    "genre:electronic": { src: "/collections/electronic.webp", ink: "#E3DBD1", theme: "#08080a", light: { src: "/collections/light/electronic.webp", ink: "#2b2823", theme: "#d2cbbf" } },
    "genre:electropop": { src: "/collections/electropop.webp", ink: "#CCDEF2", theme: "#010102", light: { src: "/collections/light/electropop.webp", ink: "#2a2724", theme: "#cccbca" } },
    "genre:europop": { src: "/collections/europop.webp", ink: "#D8DDDE", theme: "#20262c", light: { src: "/collections/light/europop.webp", ink: "#302d28", theme: "#efefef" } },
    "genre:folk": { src: "/collections/folk.webp", ink: "#F8D7BB", theme: "#030302", light: { src: "/collections/light/folk.webp", ink: "#2c2922", theme: "#dee4e6" } },
    "genre:folk rock": { src: "/collections/folk-rock.webp", ink: "#EBDAC8", theme: "#0c0908", light: { src: "/collections/light/folk-rock.webp", ink: "#2b2721", theme: "#b9a486" } },
    "genre:funk": { src: "/collections/funk.webp", ink: "#FFD5B2", theme: "#060301", light: { src: "/collections/light/funk.webp", ink: "#3e3123", theme: "#ac9277" } },
    "genre:glam metal": { src: "/collections/glam-metal.webp", ink: "#F1D6D8", theme: "#050002", light: { src: "/collections/light/glam-metal.webp", ink: "#2a2723", theme: "#b6b1ae" } },
    "genre:glam rock": { src: "/collections/glam-rock.webp", ink: "#DDDBE1", theme: "#020103", light: { src: "/collections/light/glam-rock.webp", ink: "#2b2722", theme: "#d8c7b3" } },
    "genre:hard rock": { src: "/collections/hard-rock.webp", ink: "#FAD6C3", theme: "#0a090a", light: { src: "/collections/light/hard-rock.webp", ink: "#d7cdc2", theme: "#9a948e" } },
    "genre:heavy metal": { src: "/collections/heavy-metal.webp", ink: "#DDDCD8", theme: "#030405", light: { src: "/collections/light/heavy-metal.webp", ink: "#2c2a27", theme: "#dee7f2" } },
    "genre:hip hop": { src: "/collections/hip-hop.webp", ink: "#F4D8B8", theme: "#010103", light: { src: "/collections/light/hip-hop.webp", ink: "#2b251f", theme: "#f3e3c8" } },
    "genre:indie rock": { src: "/collections/indie-rock.webp", ink: "#E6DBCC", theme: "#010306", light: { src: "/collections/light/indie-rock.webp", ink: "#29241e", theme: "#7d7162" } },
    "genre:jazz": { src: "/collections/jazz.webp", ink: "#E6DBCC", theme: "#141415", light: { src: "/collections/light/jazz.webp", ink: "#c8c5be", theme: "#cec5b9" } },
    "genre:new wave": { src: "/collections/new-wave.webp", ink: "#F0D7D4", theme: "#040306", light: { src: "/collections/light/new-wave.webp", ink: "#2f2b27", theme: "#dbd7d4" } },
    "genre:pop": { src: "/collections/pop.webp", ink: "#F4ECD8", theme: "#0d0e0e", light: { src: "/collections/light/pop.webp", ink: "#2d2923", theme: "#cebda6" } },
    "genre:pop punk": { src: "/collections/pop-punk.webp", ink: "#DFDCD6", theme: "#000000", light: { src: "/collections/light/pop-punk.webp", ink: "#2b2722", theme: "#8c7e6d" } },
    "genre:pop rap": { src: "/collections/pop-rap.webp", ink: "#FCD2E1", theme: "#0f0b11", light: { src: "/collections/light/pop-rap.webp", ink: "#282521", theme: "#e4dfdc" } },
    "genre:pop rock": { src: "/collections/pop-rock.webp", ink: "#EFD9BF", theme: "#0a1110", light: { src: "/collections/light/pop-rock.webp", ink: "#2a2724", theme: "#ecf4fc" } },
    "genre:post-grunge": { src: "/collections/post-grunge.webp", ink: "#DEDCD5", theme: "#060806", light: { src: "/collections/light/post-grunge.webp", ink: "#282621", theme: "#e4e7eb" } },
    "genre:r&b": { src: "/collections/r-and-b.webp", ink: "#E5DAD0", theme: "#07080a", light: { src: "/collections/light/r-and-b.webp", ink: "#2a241f", theme: "#94846f" } },
    "genre:rock": { src: "/collections/rock.webp", ink: "#EADCBF", theme: "#080506", light: { src: "/collections/light/rock.webp", ink: "#2a241d", theme: "#c1ab98" } },
    "genre:rock and roll": { src: "/collections/rock-and-roll.webp", ink: "#F2D9BC", theme: "#010000", light: { src: "/collections/light/rock-and-roll.webp", ink: "#3e352b", theme: "#aba6a1" } },
    "genre:rockabilly": { src: "/collections/rockabilly.webp", ink: "#EDD9C7", theme: "#010101", light: { src: "/collections/light/rockabilly.webp", ink: "#2c2621", theme: "#ad8373" } },
    "genre:singer-songwriter": { src: "/collections/singer-songwriter.webp", ink: "#DDDCD8", theme: "#0a0e10", light: { src: "/collections/light/singer-songwriter.webp", ink: "#2a2622", theme: "#c1d5e4" } },
    "genre:soft rock": { src: "/collections/soft-rock.webp", ink: "#ECD9C8", theme: "#000000", light: { src: "/collections/light/soft-rock.webp", ink: "#2b2925", theme: "#c2dfef" } },
    "genre:soul": { src: "/collections/soul.webp", ink: "#EED9C4", theme: "#0f0b05", light: { src: "/collections/light/soul.webp", ink: "#ded1c2", theme: "#8e7a5c" } },
    "genre:synth-pop": { src: "/collections/synth-pop.webp", ink: "#D2DEE8", theme: "#000103", light: { src: "/collections/light/synth-pop.webp", ink: "#2c2924", theme: "#c3c0b3" } },
    "genre:teen pop": { src: "/collections/teen-pop.webp", ink: "#F7D4D9", theme: "#040204", light: { src: "/collections/light/teen-pop.webp", ink: "#2d2823", theme: "#c5b6a4" } },
    "lang:swe": { src: "/collections/swedish.webp", ink: "#F2E8D5", theme: "#060302", light: { src: "/collections/light/swedish.webp", ink: "#2d2924", theme: "#bcab99" } },
};
...
function scrimForInk(ink: string): string {
    ...
    return "linear-gradient(to top, rgba(242,237,228,0.82) 0%, rgba(242,237,228,0.24) 55%, transparent 100%)";
}

function shadowForInk(ink: string): string {
    if (hexLuminance(ink) > 0.45) return "0 1px 10px rgba(0,0,0,0.85)";
